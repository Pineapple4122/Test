...
Cesium.Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI3ZWUxMjE1NS0wZmQ3LTQ0YTctOGNmNi03OTc0NDhkNDFhZDAiLCJpZCI6NzU0NDYsImlhdCI6MTYzODYxNTQzMH0.g667ikTe3Ra3wa5t6ECkaMj3Ph9URfAybayfTeI0ikU';
var viewer = null;
...
export var initMap = function (cesiumContainer) {
  ...
  viewer.camera.setView({//镜头的经纬度、高度。镜头默认情况下，在指定经纬高度俯视（pitch=-90）地球
    destination: Cesium.Cartesian3.fromDegrees(-122.4, 37.64, 15000),//北京15000公里上空
    orientation: {
